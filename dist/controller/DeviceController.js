...
class DeviceController {
    constructor(_deviceService) {
        ...
        this.getSensors = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            console.log("total pages ", pages, "Current page ", current);
            //1) else ?searchOption=<%=searchOption%>&searchValue=<%=searchValue%>&salary=<%=salary%>
            //2 ) else ?searchOption=<%=searchOption%>&searchValue=<%=searchValue%>&salary=<%=salary%>
            //3) else ?searchOption=<%=searchOption%>&searchValue=<%=searchValue%>&salary=<%=salary%>
